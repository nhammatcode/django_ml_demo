...
'''
Create 3 models:
0. Endpoint - to keep information about our endpoints,

1. MLAlgorithm - to keep information about ML algorithms used in the service,
2. MLAlgorithmStatus - to keep information about ML algorithm statuses. 
The status can change in time, for example, 
we can set testing as initial status and 
then after testing period switch to production state.
3. MLRequest - to keep information about all requests to ML algorithms. 
It will be needed to monitor ML algorithms and run A/B tests.
'''
